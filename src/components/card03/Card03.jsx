...
const Card03 = ({suit}) => {
  return (
    ...
    <div className='card-frame'>
      <p className={suit === 'hearts' || suit === 'diamonds' ? "first-digit red": "first-digit black"}>3</p>
            ...
            {suit === 'diamonds' && <GiDiamonds className='middle-diamond'/>}
            {suit === 'clubs' && <GiClubs className='middle-club'/>}
            {suit === 'spades' && <GiSpades className='middle-spade'/>}
            
            {suit === 'hearts' && <GiHearts className='second-heart-03'/>}
            ...
            <p className={suit === 'hearts' || suit === 'diamonds' ? "second-digit red": "second-digit black"}>3</p>
    </div>
  )
}
